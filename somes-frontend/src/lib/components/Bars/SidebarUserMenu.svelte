...
<div class="group relative">
	...
	<!-- The pb-3 bridges the gap between trigger and card so the hover does not break -->
	<div
		class="pointer-events-none absolute bottom-full left-0 z-50 pb-3 opacity-0 transition-opacity duration-100 group-focus-within:pointer-events-auto group-focus-within:opacity-100 group-hover:pointer-events-auto group-hover:opacity-100"
	>
		<div
