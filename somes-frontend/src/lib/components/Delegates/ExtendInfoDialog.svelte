...
<Dialog.Root>
    ...
    <Dialog.Portal>
        ...
        <Dialog.Content class="
            ...
            outline-hidden fixed left-[50%] top-[50%] z-70 translate-x-[-50%] translate-y-[-50%] w-7xl 2xl:max-w-7xl max-w-[90%] h-[90vh] bg-primary-100 dark:bg-gray-800 shadow-lg rounded-lg overflow-hidden"
        >
            {@render children?.()}
        </Dialog.Content>
    </Dialog.Portal>
