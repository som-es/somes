...
<button
	...
	role="switch"
	aria-label={lightModeStore.value == 'dark' ? 'Helles Design aktivieren' : 'Dunkles Design aktivieren'}
	aria-checked={lightModeStore.value == 'dark'}
	title={lightModeStore.value == 'dark' ? 'Helles Design aktivieren' : 'Dunkles Design aktivieren'}
	onclick={() => {
