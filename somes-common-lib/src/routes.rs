...
pub const PARLIAMENT_QA_ROUTE: &str = "/parliament_qa";
...
pub const DIVISION_ACCURACY_SCORE_PER_DELEGATE: &str = "/division_accuracy_score_per_delegate";
...
pub const IS_RIGHT_PER_DELEGATE: &str = "/is_right_per_delegate";
pub const IS_RIGHT_PER_PARTY: &str = "/is_right_per_party";
pub const IS_RIGHT_PER_GENDER: &str = "/is_right_per_gender";
pub const IS_RIGHT_PER_AGE: &str = "/is_right_per_age";
pub const IS_RIGHT_PER_LEGIS: &str = "/is_right_per_legis";
...
pub const IS_AUTHORITARIAN_PER_DELEGATE: &str = "/is_authoritarian_per_delegate";
pub const IS_AUTHORITARIAN_PER_PARTY: &str = "/is_authoritarian_per_party";
pub const IS_AUTHORITARIAN_PER_GENDER: &str = "/is_authoritarian_per_gender";
pub const IS_AUTHORITARIAN_PER_AGE: &str = "/is_authoritarian_per_age";
pub const IS_AUTHORITARIAN_PER_LEGIS: &str = "/is_authoritarian_per_legis";
pub const POLITICAL_SPECTRUM_PER_DELEGATE: &str = "/political_spectrum_per_delegate";
pub const POLITICAL_SPECTRUM_PER_PARTY: &str = "/political_spectrum_per_party";
pub const POLITICAL_SPECTRUM_PER_GENDER: &str = "/political_spectrum_per_gender";
pub const POLITICAL_SPECTRUM_PER_AGE: &str = "/political_spectrum_per_age";
...
pub const VOTE_RESULT: &str = "/vote_result";
...
pub const PUSH_TOKEN: &str = "/token";
pub const PUSH_TOKENS: &str = "/tokens";
pub const PUSH_SETTINGS: &str = "/settings";
