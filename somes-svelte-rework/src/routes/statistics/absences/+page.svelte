<script lang="ts">
	...
	const delegateSimpleAbsences = async (
		...
		const response =
			errorToNull(
				await justPostStatistics<DelegateAbsences[]>('absences_per_delegate', {
					legis_period: gp,
					party: null,
					gender,
					is_desc: isDesc,
	...
	const partySimpleAbsences = async (
		...
		const response =
			errorToNull(
				await justPostStatistics<DelegateAbsences[]>('absences_per_party', {
					legis_period: gp,
					party: null,
					gender,
					is_desc: isDesc,
	...
	const genderSimpleAbsences = async (
		...
		const response =
			errorToNull(
				await justPostStatistics<DelegateAbsences[]>('absences_per_gender', {
					legis_period: gp,
					party: null,
					gender,
					is_desc: isDesc,
	...
	const ageSimpleAbsences = async (
		...
		const response =
			errorToNull(
				await justPostStatistics<DelegateAbsences[]>('absences_per_age', {
					legis_period: gp,
					party: null,
					gender,
					is_desc: isDesc,
	...
	const legisSimpleAbsences = async (
		...
		const response =
			errorToNull(
				await justPostStatistics<DelegateAbsences[]>('absences_per_legis', {
					legis_period: gp,
					party: null,
					gender,
					is_desc: isDesc,
...
<Container>
	<DelegateBarChartControl
		...
		id={0}
		delegateMakeRequest={delegateSimpleAbsences}
		title="Abwesenheiten pro Abgeordneten"
	/>
</Container>
...
<Container>
	<DelegateBarChartControl
		...
		id={1}
		delegateMakeRequest={partySimpleAbsences}
		title="Abwesenheiten nach Parteien"
	/>
</Container>
...
<Container>
	<DelegateBarChartControl
		...
		id={2}
		delegateMakeRequest={genderSimpleAbsences}
		title="Abwesenheiten nach Gender"
	/>
</Container>
...
<Container>
	<DelegateBarChartControl
		...
		id={3}
		delegateMakeRequest={ageSimpleAbsences}
		title="Abwesenheiten nach Alter"
	/>
</Container>
...
<Container>
	<DelegateBarChartControl
		...
		id={4}
		delegateMakeRequest={legisSimpleAbsences}
		title="Abwesenheiten nach Legislaturperiode"
	/>
</Container>
