<script lang="ts">
	...
	const delegateSimpleAge = async (
		...
		const response =
			errorToNull(
				await justPostStatistics<DelegateAge[]>('age_of_delegates', {
					legis_period: gp,
					party: null,
					gender,
					is_desc: isDesc,
	...
	const partySimpleAge = async (
		...
		const response =
			errorToNull(
				await justPostStatistics<DelegateAge[]>('age_per_party', {
					legis_period: gp,
					party: null,
					gender,
					is_desc: isDesc,
	...
	const genderSimpleAge = async (
		...
		const response =
			errorToNull(
				await justPostStatistics<DelegateAge[]>('age_per_gender', {
					legis_period: gp,
					party: null,
					gender,
					is_desc: isDesc,
	...
	const legisSimpleAge = async (
		...
		const response =
			errorToNull(
				await justPostStatistics<DelegateAge[]>('age_per_legis', {
					legis_period: gp,
					party: null,
					gender,
					is_desc: isDesc,
...
<Container>
	<DelegateBarChartControl
		...
		id={0}
		delegateMakeRequest={delegateSimpleAge}
		title="Alter pro Abgeordneten"
	/>
</Container>
...
<Container>
	<DelegateBarChartControl
		...
		id={1}
		delegateMakeRequest={partySimpleAge}
		title="Alter nach Parteien"
	/>
</Container>
...
<Container>
	<DelegateBarChartControl
		...
		id={2}
		delegateMakeRequest={genderSimpleAge}
		title="Alter nach Gender"
	/>
</Container>
...
<Container>
	<DelegateBarChartControl
		...
		id={4}
		delegateMakeRequest={legisSimpleAge}
		title="Alter nach Legislaturperiode"
	/>
</Container>
