<script lang="ts">
	...
	const delegateSimpleComplexity = async (
		...
		const response =
			errorToNull(
				await justPostStatistics<DelegateComplexity[]>('complexity_per_delegate', {
					legis_period: gp,
					party: null,
					gender,
					is_desc: isDesc,
	...
	const partySimpleComplexity = async (
		...
		const response =
			errorToNull(
				await justPostStatistics<DelegateComplexity[]>('complexity_per_party', {
					legis_period: gp,
					party: null,
					gender,
					is_desc: isDesc,
	...
	const genderSimpleComplexity = async (
		...
		const response =
			errorToNull(
				await justPostStatistics<DelegateComplexity[]>('complexity_per_gender', {
					legis_period: gp,
					party: null,
					gender,
					is_desc: isDesc,
	...
	const ageSimpleComplexity = async (
		...
		const response =
			errorToNull(
				await justPostStatistics<DelegateComplexity[]>('complexity_at_age', {
					legis_period: gp,
					party: null,
					gender,
					is_desc: isDesc,
	...
	const legisSimpleComplexity = async (
		...
		const response =
			errorToNull(
				await justPostStatistics<DelegateComplexity[]>('complexity_per_legis', {
					legis_period: gp,
					party: null,
					gender,
					is_desc: isDesc,
...
<Container>
	<DelegateBarChartControl
		...
		id={0}
		delegateMakeRequest={delegateSimpleComplexity}
		title="Sprachkomplexität pro Abgeordneten"
	/>
</Container>
...
<Container>
	<DelegateBarChartControl
		...
		id={1}
		delegateMakeRequest={partySimpleComplexity}
		title="Sprachkomplexität nach Parteien"
	/>
</Container>
...
<Container>
	<DelegateBarChartControl
		...
		id={2}
		delegateMakeRequest={genderSimpleComplexity}
		title="Sprachkomplexität nach Gender"
	/>
</Container>
...
<Container>
	<DelegateBarChartControl
		...
		id={3}
		delegateMakeRequest={ageSimpleComplexity}
		title="Sprachkomplexität nach Alter"
	/>
</Container>
...
<Container>
	<DelegateBarChartControl
		...
		id={4}
		delegateMakeRequest={legisSimpleComplexity}
		title="Sprachkomplexität nach Legislaturperiode"
	/>
</Container>
