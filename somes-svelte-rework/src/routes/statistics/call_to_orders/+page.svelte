<script lang="ts">
	...
	const delegateSimpleCallsToOrder = async (
		...
		const response =
			errorToNull(
				await justPostStatistics<DelegateCallsToOrder[]>('call_to_orders_by_delegate', {
					legis_period: gp,
					party: null,
					gender,
					is_desc: isDesc,
	...
	const partySimpleCallsToOrder = async (
		...
		const response =
			errorToNull(
				await justPostStatistics<DelegateCallsToOrder[]>('call_to_orders_per_party', {
					legis_period: gp,
					party: null,
					gender,
					is_desc: isDesc,
	...
	const genderSimpleCallsToOrder = async (
		...
		const response =
			errorToNull(
				await justPostStatistics<DelegateCallsToOrder[]>('call_to_orders_per_gender', {
					legis_period: gp,
					party: null,
					gender,
					is_desc: isDesc,
	...
	const ageSimpleCallsToOrder = async (
		...
		const response =
			errorToNull(
				await justPostStatistics<DelegateCallsToOrder[]>('call_to_orders_per_age', {
					legis_period: gp,
					party: null,
					gender,
					is_desc: isDesc,
	...
	const legisSimpleCallsToOrder = async (
		...
		const response =
			errorToNull(
				await justPostStatistics<DelegateCallsToOrder[]>('call_to_orders_per_legis', {
					legis_period: gp,
					party: null,
					gender,
					is_desc: isDesc,
...
<Container>
	<DelegateBarChartControl
		...
		id={0}
		delegateMakeRequest={delegateSimpleCallsToOrder}
		title="Ordnungsrufe pro Abgeordneten"
	/>
</Container>
...
<Container>
	<DelegateBarChartControl
		...
		id={1}
		delegateMakeRequest={partySimpleCallsToOrder}
		title="Ordnungsrufe nach Parteien"
	/>
</Container>
...
<Container>
	<DelegateBarChartControl
		...
		id={2}
		delegateMakeRequest={genderSimpleCallsToOrder}
		title="Ordnungsrufe nach Gender"
	/>
</Container>
...
<Container>
	<DelegateBarChartControl
		...
		id={3}
		delegateMakeRequest={ageSimpleCallsToOrder}
		title="Ordnungsrufe nach Alter"
	/>
</Container>
...
<Container>
	<DelegateBarChartControl
		...
		id={4}
		delegateMakeRequest={legisSimpleCallsToOrder}
		title="Ordnungsrufe nach Legislaturperiode"
	/>
</Container>
