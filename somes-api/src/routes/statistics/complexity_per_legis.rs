...
pub struct LegisComplexityFilter {
    party: Option<String>,
...
pub async fn complexity_per_legis(
    ...
    Json(filter): Json<Option<LegisComplexityFilter>>,
) -> Result<Json<Vec<LegisComplexity>>, StatisticsResponse> {
...
ORDER BY 
    ...
    let mut filtered_query = sqlx::query_as::<Postgres, LegisComplexity>(&query);
