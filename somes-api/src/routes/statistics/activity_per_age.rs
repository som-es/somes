...
pub struct AgeActivityFilter {
    legis_period: Option<String>,
    is_desc: bool,
}

#[derive(ToSchema, PartialEq, Debug, Clone, FromRow, Serialize, Deserialize)]
pub struct AgeActivity {
    age_group: String,
...
pub async fn activity_per_age(
    ...
    Json(filter): Json<Option<AgeActivityFilter>>,
) -> Result<Json<Vec<AgeActivity>>, StatisticsResponse> {
...
ORDER BY 
    ...
    let mut filtered_query = sqlx::query_as::<Postgres, AgeActivity>(&query);
