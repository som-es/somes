...
pub struct GenderActivityFilter {
...
pub async fn activity_per_gender(
    ...
    Json(filter): Json<Option<GenderActivityFilter>>,
) -> Result<Json<Vec<GenderActivity>>, StatisticsResponse> {
...
ORDER BY 
    ...
    let mut filtered_query = sqlx::query_as::<Postgres, GenderActivity>(&query);
