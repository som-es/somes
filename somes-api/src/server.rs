...
use somes_common_lib::{
    ...
    PROPOSALS_ROUTE, SIGNUP_ROUTE, SPEAKERS_BY_HOURS, VERIFY_ROUTE, DELEGATES_BY_CALL_TO_ORDERS_AND_LEGIS_PERIOD,
};
...
use crate::{
    routes::{
        ...
        speakers_by_hours, delegates_by_call_to_orders_by_legis_period,
    },
